...
namespace OneOf
{
    public class OneOfBase<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> : IOneOf
    {
        ...
        public async System.Threading.Tasks.Task<TResult> MatchAsync<TResult>(Func<T0, System.Threading.Tasks.Task<TResult>> f0, Func<T1, System.Threading.Tasks.Task<TResult>> f1, Func<T2, System.Threading.Tasks.Task<TResult>> f2, Func<T3, System.Threading.Tasks.Task<TResult>> f3, Func<T4, System.Threading.Tasks.Task<TResult>> f4, Func<T5, System.Threading.Tasks.Task<TResult>> f5, Func<T6, System.Threading.Tasks.Task<TResult>> f6, Func<T7, System.Threading.Tasks.Task<TResult>> f7, Func<T8, System.Threading.Tasks.Task<TResult>> f8, Func<T9, System.Threading.Tasks.Task<TResult>> f9)
        {
            if (_index == 0 && f0 != null)
            {
