...
namespace OneOf
{
    public class OneOfBase<T0, T1, T2, T3, T4, T5> : IOneOf
    {
        ...
        public async System.Threading.Tasks.Task<TResult> MatchAsync<TResult>(Func<T0, System.Threading.Tasks.Task<TResult>> f0, Func<T1, System.Threading.Tasks.Task<TResult>> f1, Func<T2, System.Threading.Tasks.Task<TResult>> f2, Func<T3, System.Threading.Tasks.Task<TResult>> f3, Func<T4, System.Threading.Tasks.Task<TResult>> f4, Func<T5, System.Threading.Tasks.Task<TResult>> f5)
        {
            if (_index == 0 && f0 != null)
            {
